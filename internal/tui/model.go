...
func metricBox(label, value string, tone string) string {
	...
	switch tone {
	case cyanTone:
		style = style.BorderForeground(blueSoftColor)
	case greenTone:
...
var (
	headerBarStyle        = lipgloss.NewStyle().Background(baseColor).Foreground(textColor)
	titleStyle            = lipgloss.NewStyle().Bold(true).Foreground(textColor).Background(blueColor)
	monitorStyle          = lipgloss.NewStyle().Foreground(textColor).Background(surfaceLiftColor)
	sectionStyle          = lipgloss.NewStyle().Bold(true).Foreground(textColor).Background(surfaceLiftColor)
	subtleStyle           = lipgloss.NewStyle().Foreground(mutTextColor)
	kickerStyle           = lipgloss.NewStyle().Foreground(blueSoftColor).Bold(true)
	labelStyle            = lipgloss.NewStyle().Foreground(tealColor).Bold(true)
	valueStyle            = lipgloss.NewStyle().Foreground(warmTextColor).Bold(true)
	accentStyle           = lipgloss.NewStyle().Foreground(blueColor).Bold(true)
	eventTypeStyle        = lipgloss.NewStyle().Foreground(tealColor).Bold(true)
	userContentStyle      = lipgloss.NewStyle().Foreground(textColor).Background(blueDeepColor).Bold(true).Padding(0, 1)
	...
	cardStyle             = lipgloss.NewStyle().Foreground(textColor).Background(surfaceColor).Border(lipgloss.NormalBorder()).BorderForeground(blueSoftColor).Padding(0, 1).MarginRight(1)
	miniCardStyle         = lipgloss.NewStyle().Foreground(textColor).Background(surfaceColor).Border(lipgloss.RoundedBorder()).BorderForeground(surfaceEdgeColor).Padding(0, 1).MarginRight(1).Width(14)
	footerStyle           = lipgloss.NewStyle().Foreground(mutTextColor).MarginTop(1)
	tabStyle              = lipgloss.NewStyle().Padding(0, 2).Foreground(mutTextColor).Background(baseColor)
	activeTabStyle        = lipgloss.NewStyle().Padding(0, 2).Bold(true).Foreground(textColor).Background(blueDeepColor)
	sessionRowStyle       = lipgloss.NewStyle().Foreground(textColor)
	selectedRowStyle      = lipgloss.NewStyle().Foreground(textColor).Background(surfaceLiftColor).Bold(true)
	activeStatusStyle     = lipgloss.NewStyle().Foreground(inkColor).Background(greenColor).Bold(true).Padding(0, 1)
	idleStatusStyle       = lipgloss.NewStyle().Foreground(textColor).Background(surfaceSoftColor).Bold(true).Padding(0, 1)
	...
	idleBarStyle          = lipgloss.NewStyle().Foreground(blueSoftColor)
	warningBarStyle       = lipgloss.NewStyle().Foreground(amberColor)
	trackStyle            = lipgloss.NewStyle().Foreground(trackColor)
	scrollHintStyle       = lipgloss.NewStyle().Foreground(textColor).Background(surfaceSoftColor).Padding(0, 1)
)
...
var (
	inkColor         = lipgloss.Color("#0B1220")
	textColor        = lipgloss.Color("#E5E7EB")
	warmTextColor    = lipgloss.Color("#F8FAFC")
	mutTextColor     = lipgloss.Color("#94A3B8")
	baseColor        = lipgloss.Color("#0F172A")
	surfaceDeepColor = lipgloss.Color("#111827")
	surfaceColor     = lipgloss.Color("#1F2937")
	surfaceSoftColor = lipgloss.Color("#334155")
	surfaceLiftColor = lipgloss.Color("#374151")
	surfaceEdgeColor = lipgloss.Color("#475569")
	blueColor        = lipgloss.Color("#60A5FA")
	blueSoftColor    = lipgloss.Color("#93C5FD")
	blueDeepColor    = lipgloss.Color("#1D4ED8")
	tealColor        = lipgloss.Color("#2DD4BF")
	greenColor       = lipgloss.Color("#34D399")
	amberColor       = lipgloss.Color("#FBBF24")
	violetColor      = lipgloss.Color("#A78BFA")
	trackColor       = lipgloss.Color("#475569")
)
